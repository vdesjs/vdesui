      ...
      return (
        <div class="vdes-switch" onClick={onClick}>
          <div class="vdes-switch-wrapper">
            {type == 'switch' ? (
              <div
                class={`vdes-switch-input ${
                  switchChecked.value ? 'vdes-switch-input-checked' : ''
                }`}
                style={{
              ...
              <div
                class={`vdes-checkbox-input ${
                  switchChecked.value ? 'vdes-checkbox-input-checked' : ''
                }`}
              ></div>
            )}
          </div>
...
.vdes-switch {
  ...
  .vdes-switch-wrapper {
    ...
    .vdes-checkbox-input {
      ...
      &.vdes-checkbox-input-checked {
        &:before {
          font: normal normal normal 14px/1 'vdesui';
          content: '\EA08';
          color: inherit;
          font-size: 22px;
          position: absolute;
